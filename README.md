...
git clone https://github.com/Khaled-AlKhateeb/vet-clinic-database.git
...
Feel free to check the [issues page](https://github.com/Khaled-AlKhateeb/vet-clinic-database/issues).
